...
export const PlaybackDock = ({
  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 z-50 border-t border-white/8 bg-[rgba(6,13,23,0.94)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1900px] flex-col gap-3 px-3 py-3 sm:px-4 lg:flex-row lg:items-center lg:px-6">
